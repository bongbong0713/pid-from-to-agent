...
class PIDTracer:
    ...
    def _get_fallback_result(self, pipe_label: str) -> Optional[Dict]:
        """
        Return fallback mapping result for a pipe label if available.

        Args:
            pipe_label: Pipe label to look up
